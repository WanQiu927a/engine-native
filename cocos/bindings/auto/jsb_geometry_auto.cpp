...
static bool js_geometry_AABB_constructor(se::State &s) // NOLINT(readability-identifier-naming) constructor_overloaded.c
{
    ...
    do {
        if (argc == 6) {
            ...
            cc::geometry::AABB *cobj = JSB_ALLOC(cc::geometry::AABB, arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
...
static bool js_geometry_Capsule_constructor(se::State &s) // NOLINT(readability-identifier-naming) constructor_overloaded.c
{
    ...
    do {
        if (argc == 1) {
            ...
            cc::geometry::Capsule *cobj = JSB_ALLOC(cc::geometry::Capsule, arg0.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 0) {
            cc::geometry::Capsule *cobj = JSB_ALLOC(cc::geometry::Capsule);
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 2) {
            ...
            cc::geometry::Capsule *cobj = JSB_ALLOC(cc::geometry::Capsule, arg0.value(), arg1.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 3) {
            ...
            cc::geometry::Capsule *cobj = JSB_ALLOC(cc::geometry::Capsule, arg0.value(), arg1.value(), arg2.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
...
{
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cc::geometry::Capsule>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end()) {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        auto *cobj = SE_THIS_OBJECT<cc::geometry::Capsule>(s);
        JSB_FREE(cobj);
...
static bool js_geometry_Plane_constructor(se::State &s) // NOLINT(readability-identifier-naming) constructor_overloaded.c
{
    ...
    do {
        if (argc == 4) {
            ...
            cc::geometry::Plane *cobj = JSB_ALLOC(cc::geometry::Plane, arg0.value(), arg1.value(), arg2.value(), arg3.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
...
static bool js_geometry_Line_constructor(se::State &s) // NOLINT(readability-identifier-naming) constructor_overloaded.c
{
    ...
    do {
        if (argc == 1) {
            ...
            cc::geometry::Line *cobj = JSB_ALLOC(cc::geometry::Line, arg0.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 0) {
            cc::geometry::Line *cobj = JSB_ALLOC(cc::geometry::Line);
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 2) {
            ...
            cc::geometry::Line *cobj = JSB_ALLOC(cc::geometry::Line, arg0.value(), arg1.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 3) {
            ...
            cc::geometry::Line *cobj = JSB_ALLOC(cc::geometry::Line, arg0.value(), arg1.value(), arg2.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 4) {
            ...
            cc::geometry::Line *cobj = JSB_ALLOC(cc::geometry::Line, arg0.value(), arg1.value(), arg2.value(), arg3.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 5) {
            ...
            cc::geometry::Line *cobj = JSB_ALLOC(cc::geometry::Line, arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 6) {
            ...
            cc::geometry::Line *cobj = JSB_ALLOC(cc::geometry::Line, arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
...
{
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cc::geometry::Line>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end()) {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        auto *cobj = SE_THIS_OBJECT<cc::geometry::Line>(s);
        JSB_FREE(cobj);
...
static bool js_geometry_Ray_constructor(se::State &s) // NOLINT(readability-identifier-naming) constructor_overloaded.c
{
    ...
    do {
        if (argc == 1) {
            ...
            cc::geometry::Ray *cobj = JSB_ALLOC(cc::geometry::Ray, arg0.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 0) {
            cc::geometry::Ray *cobj = JSB_ALLOC(cc::geometry::Ray);
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 2) {
            ...
            cc::geometry::Ray *cobj = JSB_ALLOC(cc::geometry::Ray, arg0.value(), arg1.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 3) {
            ...
            cc::geometry::Ray *cobj = JSB_ALLOC(cc::geometry::Ray, arg0.value(), arg1.value(), arg2.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 4) {
            ...
            cc::geometry::Ray *cobj = JSB_ALLOC(cc::geometry::Ray, arg0.value(), arg1.value(), arg2.value(), arg3.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 5) {
            ...
            cc::geometry::Ray *cobj = JSB_ALLOC(cc::geometry::Ray, arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 6) {
            ...
            cc::geometry::Ray *cobj = JSB_ALLOC(cc::geometry::Ray, arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
...
{
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cc::geometry::Ray>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end()) {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        auto *cobj = SE_THIS_OBJECT<cc::geometry::Ray>(s);
        JSB_FREE(cobj);
    }
    return true;
}
...
{
    cc::geometry::Sphere *cobj = JSB_ALLOC(cc::geometry::Sphere);
    s.thisObject()->setPrivateData(cobj);
    se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
    return true;
}
...
{
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cc::geometry::Sphere>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end()) {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        auto *cobj = SE_THIS_OBJECT<cc::geometry::Sphere>(s);
        JSB_FREE(cobj);
...
static bool js_geometry_Triangle_constructor(se::State &s) // NOLINT(readability-identifier-naming) constructor_overloaded.c
{
    ...
    do {
        if (argc == 1) {
            ...
            cc::geometry::Triangle *cobj = JSB_ALLOC(cc::geometry::Triangle, arg0.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 0) {
            cc::geometry::Triangle *cobj = JSB_ALLOC(cc::geometry::Triangle);
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 2) {
            ...
            cc::geometry::Triangle *cobj = JSB_ALLOC(cc::geometry::Triangle, arg0.value(), arg1.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 3) {
            ...
            cc::geometry::Triangle *cobj = JSB_ALLOC(cc::geometry::Triangle, arg0.value(), arg1.value(), arg2.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 4) {
            ...
            cc::geometry::Triangle *cobj = JSB_ALLOC(cc::geometry::Triangle, arg0.value(), arg1.value(), arg2.value(), arg3.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 5) {
            ...
            cc::geometry::Triangle *cobj = JSB_ALLOC(cc::geometry::Triangle, arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 6) {
            ...
            cc::geometry::Triangle *cobj = JSB_ALLOC(cc::geometry::Triangle, arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 7) {
            ...
            cc::geometry::Triangle *cobj = JSB_ALLOC(cc::geometry::Triangle, arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value(), arg6.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 8) {
            ...
            cc::geometry::Triangle *cobj = JSB_ALLOC(cc::geometry::Triangle, arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value(), arg6.value(), arg7.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
    ...
    do {
        if (argc == 9) {
            ...
            cc::geometry::Triangle *cobj = JSB_ALLOC(cc::geometry::Triangle, arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value(), arg6.value(), arg7.value(), arg8.value());
            s.thisObject()->setPrivateData(cobj);
            se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
            return true;
        }
...
{
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cc::geometry::Triangle>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end()) {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        auto *cobj = SE_THIS_OBJECT<cc::geometry::Triangle>(s);
        JSB_FREE(cobj);
    }
    return true;
}
