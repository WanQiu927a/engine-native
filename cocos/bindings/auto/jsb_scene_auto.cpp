...
static bool js_scene_Scene_constructor(se::State& s) // NOLINT(readability-identifier-naming) constructor.c
{
    ...
    std::string arg0;
    ok &= sevalue_to_native(args[0], &arg0, s.thisObject());
    SE_PRECONDITION2(ok, false, "js_scene_Scene_constructor : Error processing arguments");
    cc::Scene* cobj = JSB_ALLOC(cc::Scene, arg0);
    s.thisObject()->setPrivateData(cobj);
    return true;
}
...
bool js_register_scene_Scene(se::Object* obj) // NOLINT(readability-identifier-naming)
{
    ...
    cls->defineFunction("activate", _SE(js_scene_Scene_activate));
    ...
    cls->defineFunction("load", _SE(js_scene_Scene_load));
...
static bool js_scene_SceneGlobals_getShadowInfo(se::State& s) // NOLINT(readability-identifier-naming)
{
    auto* cobj = SE_THIS_OBJECT<cc::SceneGlobals>(s);
    SE_PRECONDITION2(cobj, false, "js_scene_SceneGlobals_getShadowInfo : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cc::scene::ShadowInfo* result = cobj->getShadowInfo();
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_scene_SceneGlobals_getShadowInfo : Error processing arguments");
        SE_HOLD_RETURN_VALUE(result, s.thisObject(), s.rval());
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
...
SE_BIND_FUNC(js_scene_SceneGlobals_getShadowInfo)
...
bool js_register_scene_SceneGlobals(se::Object* obj) // NOLINT(readability-identifier-naming)
{
    ...
    cls->defineFunction("getShadowInfo", _SE(js_scene_SceneGlobals_getShadowInfo));
...
SE_BIND_PROP_GET(js_scene_Ambient_getAlbedoArray)
...
SE_BIND_PROP_GET(js_scene_Ambient_getColorArray)
...
SE_BIND_PROP_GET(js_scene_Ambient_getGroundAlbedo)
...
SE_BIND_PROP_GET(js_scene_Ambient_getSkyColor)
...
SE_BIND_PROP_GET(js_scene_Ambient_getSkyIllum)
...
SE_BIND_PROP_GET(js_scene_Ambient_isEnabled)
...
SE_BIND_PROP_SET(js_scene_Ambient_setEnabled)
...
SE_BIND_PROP_SET(js_scene_Ambient_setGroundAlbedo)
...
SE_BIND_PROP_SET(js_scene_Ambient_setSkyColor)
...
SE_BIND_PROP_SET(js_scene_Ambient_setSkyIllum)
...
bool js_register_scene_Ambient(se::Object* obj) // NOLINT(readability-identifier-naming)
{
    ...
    cls->defineProperty("skyColor", _SE(js_scene_Ambient_getSkyColor), _SE(js_scene_Ambient_setSkyColor));
    cls->defineProperty("skyIllum", _SE(js_scene_Ambient_getSkyIllum), _SE(js_scene_Ambient_setSkyIllum));
    cls->defineProperty("albedoArray", _SE(js_scene_Ambient_getAlbedoArray), nullptr);
    cls->defineProperty("groundAlbedo", _SE(js_scene_Ambient_getGroundAlbedo), _SE(js_scene_Ambient_setGroundAlbedo));
    cls->defineProperty("enabled", _SE(js_scene_Ambient_isEnabled), _SE(js_scene_Ambient_setEnabled));
    cls->defineProperty("colorArray", _SE(js_scene_Ambient_getColorArray), nullptr);
...
SE_BIND_PROP_GET(js_scene_RenderWindow_getCameras)
...
SE_BIND_PROP_GET(js_scene_RenderWindow_getFramebuffer)
...
SE_BIND_PROP_GET(js_scene_RenderWindow_getHeight)
...
SE_BIND_PROP_GET(js_scene_RenderWindow_getWidth)
...
SE_BIND_PROP_GET(js_scene_RenderWindow_hasOffScreenAttachments)
...
SE_BIND_PROP_GET(js_scene_RenderWindow_hasOnScreenAttachments)
...
SE_BIND_PROP_GET(js_scene_RenderWindow_shouldSyncSizeWithSwapchain)
...
bool js_register_scene_RenderWindow(se::Object* obj) // NOLINT(readability-identifier-naming)
{
    ...
    cls->defineProperty("width", _SE(js_scene_RenderWindow_getWidth), nullptr);
    cls->defineProperty("height", _SE(js_scene_RenderWindow_getHeight), nullptr);
    cls->defineProperty("framebuffer", _SE(js_scene_RenderWindow_getFramebuffer), nullptr);
    cls->defineProperty("shouldSyncSizeWithSwapchain", _SE(js_scene_RenderWindow_shouldSyncSizeWithSwapchain), nullptr);
    cls->defineProperty("hasOnScreenAttachments", _SE(js_scene_RenderWindow_hasOnScreenAttachments), nullptr);
    cls->defineProperty("hasOffScreenAttachments", _SE(js_scene_RenderWindow_hasOffScreenAttachments), nullptr);
    cls->defineProperty("cameras", _SE(js_scene_RenderWindow_getCameras), nullptr);
...
SE_BIND_PROP_GET(js_scene_Root_getBatcher2D)
...
SE_BIND_PROP_GET(js_scene_Root_getCumulativeTime)
...
SE_BIND_PROP_GET(js_scene_Root_getCurWindow)
...
SE_BIND_PROP_GET(js_scene_Root_getDataPoolManager)
...
SE_BIND_PROP_GET(js_scene_Root_getDevice)
...
SE_BIND_PROP_GET(js_scene_Root_getFixedFPS)
...
SE_BIND_PROP_GET(js_scene_Root_getFps)
...
SE_BIND_PROP_GET(js_scene_Root_getFrameCount)
...
SE_BIND_PROP_GET(js_scene_Root_getFrameTime)
...
SE_BIND_PROP_GET(js_scene_Root_getMainWindow)
...
SE_BIND_PROP_GET(js_scene_Root_getPipeline)
...
SE_BIND_PROP_GET(js_scene_Root_getScenes)
...
SE_BIND_PROP_GET(js_scene_Root_getTempWindow)
...
SE_BIND_PROP_GET(js_scene_Root_getWindows)
...
SE_BIND_PROP_GET(js_scene_Root_isUsingDeferredPipeline)
...
SE_BIND_PROP_SET(js_scene_Root_setCurWindow)
...
SE_BIND_PROP_SET(js_scene_Root_setFixedFPS)
...
SE_BIND_PROP_SET(js_scene_Root_setTempWindow)
...
bool js_register_scene_Root(se::Object* obj) // NOLINT(readability-identifier-naming)
{
    ...
    cls->defineProperty("device", _SE(js_scene_Root_getDevice), nullptr);
    cls->defineProperty("mainWindow", _SE(js_scene_Root_getMainWindow), nullptr);
    cls->defineProperty("curWindow", _SE(js_scene_Root_getCurWindow), _SE(js_scene_Root_setCurWindow));
    cls->defineProperty("tempWindow", _SE(js_scene_Root_getTempWindow), _SE(js_scene_Root_setTempWindow));
    cls->defineProperty("windows", _SE(js_scene_Root_getWindows), nullptr);
    cls->defineProperty("pipeline", _SE(js_scene_Root_getPipeline), nullptr);
    cls->defineProperty("batcher2D", _SE(js_scene_Root_getBatcher2D), nullptr);
    cls->defineProperty("scenes", _SE(js_scene_Root_getScenes), nullptr);
    cls->defineProperty("cumulativeTime", _SE(js_scene_Root_getCumulativeTime), nullptr);
    cls->defineProperty("frameTime", _SE(js_scene_Root_getFrameTime), nullptr);
    cls->defineProperty("frameCount", _SE(js_scene_Root_getFrameCount), nullptr);
    cls->defineProperty("fps", _SE(js_scene_Root_getFps), nullptr);
    cls->defineProperty("fixedFPS", _SE(js_scene_Root_getFixedFPS), _SE(js_scene_Root_setFixedFPS));
    cls->defineProperty("dataPoolManager", _SE(js_scene_Root_getDataPoolManager), nullptr);
    cls->defineProperty("useDeferredPipeline", _SE(js_scene_Root_isUsingDeferredPipeline), nullptr);
...
bool js_register_scene_ProgramLib(se::Object* obj) // NOLINT(readability-identifier-naming)
{
    ...
    cls->defineFunction("registerEffect", _SE(js_scene_ProgramLib_registerEffect));
...
static bool js_scene_MaterialInstance_createPasses(se::State& s) // NOLINT(readability-identifier-naming)
{
    auto* cobj = SE_THIS_OBJECT<cc::MaterialInstance>(s);
    SE_PRECONDITION2(cobj, false, "js_scene_MaterialInstance_createPasses : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        std::vector<cc::scene::Pass *> result = cobj->createPasses();
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_scene_MaterialInstance_createPasses : Error processing arguments");
        SE_HOLD_RETURN_VALUE(result, s.thisObject(), s.rval());
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
...
SE_BIND_FUNC(js_scene_MaterialInstance_createPasses)
...
bool js_register_scene_MaterialInstance(se::Object* obj) // NOLINT(readability-identifier-naming)
{
    ...
    cls->defineFunction("createPasses", _SE(js_scene_MaterialInstance_createPasses));
...
SE_BIND_FUNC(js_scene_PassInstance_getParent)
...
bool js_register_scene_PassInstance(se::Object* obj) // NOLINT(readability-identifier-naming)
{
    ...
    cls->defineFunction("getParent", _SE(js_scene_PassInstance_getParent));
